...
import { ArrowRight, Upload, MessageSquare, Sparkles, Watch } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto space-y-16 py-8">
        <div className="text-center space-y-6">
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white">
            Your diet, <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">planned for your day</span>
          </h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Upload your current diet. Tell us about your routine. Optionally add smartwatch data.
            Get a daily adjusted plan — same foods, portions tuned for today.
          </p>
        ...
        <div className="grid md:grid-cols-4 gap-5">
          ...
          <GlassCard className="space-y-3" hoverEffect>
            ...
            <h3 className="text-lg font-semibold text-white">2. Add routine</h3>
            <p className="text-sm text-gray-400">Type or record how your day, training, and schedule affect your eating.</p>
          </GlassCard>
          <GlassCard className="space-y-3" hoverEffect>
            <div className="w-10 h-10 bg-cyan-500/10 rounded-xl flex items-center justify-center">
              <Watch className="w-5 h-5 text-cyan-400" />
            </div>
            <h3 className="text-lg font-semibold text-white">3. Activity data</h3>
